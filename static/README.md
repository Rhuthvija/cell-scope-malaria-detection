...
🔗 **Live demo:** https://cell-scope-malaria-detection.onrender.com/

---

## 🚧 Deployment Status

This is currently deployed as a working prototype at the link above.
...
**not yet integrated into the live deployment**. The current live version
is single-tenant. The updated backend (`app.py`, `db.py`) and new
auth/signup/researcher-portal templates are included in this repo, ready
for the next deployment pass.
...
```bash
# Clone the repo
git clone https://github.com/<your-username>/cell-scope-malaria-detection.git
